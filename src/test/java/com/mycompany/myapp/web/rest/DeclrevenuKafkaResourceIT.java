...
import com.mycompany.myapp.DeclrevenuApp;
...
@SpringBootTest(classes = DeclrevenuApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DeclrevenuKafkaResourceIT {
    ...
    @Autowired
    private DeclrevenuKafkaProducer producer;

    @Autowired
    private DeclrevenuKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclrevenuKafkaResource kafkaResource = new DeclrevenuKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declrevenu-kafka/publish?message=test"))
